class Paypal::8ItemOrderController < ApplicationController
  ...
  def index
    ...
    request.set_form_data(
      ...
      "PAYMENTREQUEST_8_AMT" => fee, # total amount of second payment \
      "PAYMENTREQUEST_8_ITEMAMT" => 0,
      "PAYMENTREQUEST_8_TAXAMT" => 0,
      "PAYMENTREQUEST_8_PAYMENTACTION" => "Order",
      "PAYMENTREQUEST_8_DESC" => "Angler District Fee",
      "PAYMENTREQUEST_8_SELLERPAYPALACCOUNTID" => "spencerdnorman-facilitator@gmail.com", # PayPal e-mail of 2nd receiver \
      "PAYMENTREQUEST_8_PAYMENTREQUESTID" => "Order#{@order.id}-PAYMENT8", # unique ID for 1st payment \
    )
    req_options = {
