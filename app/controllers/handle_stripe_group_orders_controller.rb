class HandleStripeGroupOrdersController < ApplicationController
  before_action :set_group_order, only: [:create]
  ...
  def set_group_order
    @gorup_order = GroupOrder.find(params[:id])
  end
